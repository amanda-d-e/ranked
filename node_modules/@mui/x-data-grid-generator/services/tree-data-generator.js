...
const addTreeDataOptionsToDemoData = (data, options = {}) => {
  ...
  if (data.rows.length > 1000) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: useDemoData tree data mode only works up to 1000 rows.' : (0, _formatErrorMessage2.default)(110));
  }
  ...
  if (!groupingCol) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: The tree data grouping field does not exist.' : (0, _formatErrorMessage2.default)(111));
  }
