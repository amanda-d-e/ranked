...
import { type UseDemoDataOptions } from "./useDemoData.mjs";
import type { ServerOptions, QueryOptions, PageInfo } from "./serverUtils.mjs";
export declare const createFakeServer: (dataSetOptions?: Partial<UseDemoDataOptions>, serverOptions?: ServerOptions) => {
  columns: import("../index.mjs").GridColDefGenerator[];
