...
export declare const gridChartsIntegrationChartsLookupSelector: (args_0: import("react").RefObject<{
  ...
  dimensions: import("./gridChartsIntegrationInterfaces.mjs").GridChartsIntegrationItem[];
  values: import("./gridChartsIntegrationInterfaces.mjs").GridChartsIntegrationItem[];
}>;
...
export declare const gridChartsDimensionsSelector: (args_0: import("react").RefObject<{
  state: GridStatePremium;
} | null>, chartId: any) => import("./gridChartsIntegrationInterfaces.mjs").GridChartsIntegrationItem[];
